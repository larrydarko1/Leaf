<div style="display: flex; flex-direction: row; align-items: center; justify-content: center; gap: 6px"><img draggable="false" src="src/assets/icon.png" alt="Leaf Logo" width="50"><h1 style="margin: 0; padding: 0">leaf.</h1></div>
